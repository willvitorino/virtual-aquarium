...
<template>
  <div class="fish-form w-[100%] h-full bg-blue-300">
    <div class="fish-types-container">
      <label class="text-lg text-center mb-4 font-bold text-white w-full flex justify-center">Peixes:</label>
    ...
    >
      ...
      <input type="text" v-model="fishName" class="w-full p-2 rounded-md mb-2" />
      <button
